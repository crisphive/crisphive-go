...
func (o *CustomerCreateRequest) GetAddress() CustomerAddressRequest {
...
func (o *CustomerCreateRequest) SetAddress(v CustomerAddressRequest) {
	o.Address = &v
}
...
func (o *CustomerCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varCustomerCreateRequest)
