...
func (o *JobRequestJobDateBusinessRangeRequest) GetDate() string {
...
func (o *JobRequestJobDateBusinessRangeRequest) GetDateOk() (*string, bool) {
	if o == nil || IsNil(o.Date) {
		return nil, false
	}
	return o.Date, true
...
func (o *JobRequestJobDateBusinessRangeRequest) SetDate(v string) {
	o.Date = &v
}
